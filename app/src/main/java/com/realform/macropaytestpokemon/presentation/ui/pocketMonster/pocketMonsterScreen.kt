...
import com.realform.macropaytestpokemon.presentation.ui.pocketMonster.designComponents.PocketMonsterCard
import com.realform.macropaytestpokemon.presentation.ui.theme.ThemeColor
import org.koin.androidx.compose.koinViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PocketMonsterScreen(viewModel: PocketMonsterViewModel = koinViewModel(),
        ...
        content = { // Main content area
            ...
            Column (modifier = Modifier
                ...
                LazyColumn(
                    ...
                    pokemons?.let {
                        items(it) { result ->
                            PocketMonsterCard(result){ clickedPokemon ->
